...
// public:
//  anvill::Result<anvill::FunctionDecl *, std::string>
//  DeclareFunction(anvill::FunctionDecl decl_template, bool force);
//
...
//anvill::Result<anvill::FunctionDecl *, std::string>
//Program::Impl::DeclareFunction(anvill::FunctionDecl tpl, bool force) {
//
//  if (!tpl.arch) {
//    std::stringstream ss;
//    ss << "Cannot declare a function at address " << std::hex
//       << tpl.address << " with no associated architecture";
//    return ss.str();
//  }
//
//  if (!tpl.type) {
//    std::stringstream ss;
//    ss << "Cannot declare a function at address " << std::hex
//       << tpl.address << " with no associated type";
//    return ss.str();
//  }
//
//
...
//    std::stringstream ss;
//    ss << "A function is already declared at address " << std::hex
//       << tpl.address;
//    return ss.str();
//  }
//
