...
@llvm.compiler.used = appending global [4 x i8*] [i8* bitcast (i64 (i64, i64, i32 ()*)* @sub_4003b4__All_Svl_B_0 to i8*), i8* bitcast (i32 (i32, i8**, i8**)* @main to i8*), i8* bitcast (i32 (i32 (i32, i8**, i8**)*, i32, i8**, i32 (i32, i8**, i8**)*, i32 ()*, i32 ()*, i8*)* @__libc_start_main to i8*), i8* bitcast (i64* @var_601030_l to i8*)], section "llvm.metadata"
...
define i32 @main(i32 %0, i8** %1, i8** %2) #0 {
  %4 = load i64, i64* @var_601030_l, align 8
  %5 = icmp ne i64 %4, 0
  %.sroa.0.0.insert.ext = zext i1 %5 to i32
