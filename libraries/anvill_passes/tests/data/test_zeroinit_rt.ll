...
@llvm.compiler.used = appending global [5 x i8*] [i8* bitcast (i64 (i64, i64, i32 ()*)* @sub_4003b4__All_Svl_B_0 to i8*), i8* bitcast (i32 (i32, i8**, i8**)* @main to i8*), i8* bitcast (i32 (i32 (i32, i8**, i8**)*, i32, i8**, i32 (i32, i8**, i8**)*, i32 ()*, i32 ()*, i8*)* @__libc_start_main to i8*), i8* bitcast (i32* @var_601044_i to i8*), i8* bitcast (i64* @var_6011b0_l to i8*)], section "llvm.metadata"
...
define i32 @main(i32 %0, i8** %1, i8** %2) #0 {
  %4 = load i32, i32* @var_601044_i, align 4
  %5 = icmp eq i32 %4, 0
...
8:                                                ; preds = %7, %6
  ...
  store i32 %storemerge, i32* @var_601044_i, align 4
  %9 = load i64, i64* @var_6011b0_l, align 8
  %10 = icmp eq i64 %9, 0
...
13:                                               ; preds = %12, %11
  ...
  store i64 %storemerge1, i64* @var_6011b0_l, align 8
  %15 = load i32, i32* @var_601044_i, align 4
  %16 = add i32 %15, %14
  ret i32 %16
}
