...
ControlFlowProvider::ControlFlowProvider(const Program &program) : d(new PrivateData(program)) {}

ControlFlowProvider::~ControlFlowProvider(void) {};
...
Result<ControlFlowProvider::Ptr, ControlFlowProviderError> ControlFlowProvider::Create(const Program &program) {
  try {
