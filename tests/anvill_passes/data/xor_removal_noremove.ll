; ModuleID = 'xor_removal_noremove.ll'
source_filename = "xor_removal_noremove.c"
...
define i32 @xor_removal_noremove_false(i1 zeroext %0) #0 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
  %4 = alloca i8, align 1
  %5 = zext i1 %0 to i8
...
a17:                                              ; preds = %1
  %12 = call i32 @puts(ptr getelementptr inbounds ([6 x i8], ptr @.str, i64 0, i64 0))
  br label %a21

a19:                                              ; preds = %1
  %13 = call i32 @puts(ptr getelementptr inbounds ([7 x i8], ptr @.str.1, i64 0, i64 0))
  br label %a21
...
; Function Attrs: nofree nounwind uwtable
define i32 @xor_removal_noremove_notused(i1 zeroext %0) #0 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
  %4 = alloca i8, align 1
  %5 = zext i1 %0 to i8
