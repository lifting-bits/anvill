...
@llvm.compiler.used = appending global [4 x i8*] [i8* bitcast (i64 (i64, i64, i32 ()*)* @sub_4003b4__All_Svl_B_0 to i8*), i8* bitcast (i32 (i32, i8**, i8**)* @main to i8*), i8* bitcast (i32 (i32 (i32, i8**, i8**)*, i32, i8**, i32 (i32, i8**, i8**)*, i32 ()*, i32 ()*, i8*)* @__libc_start_main to i8*), i8* bitcast (i32* @var_601034_i to i8*)], section "llvm.metadata"
...
define i32 @main(i32 %0, i8** %1, i8** %2) #0 {
  %4 = load i32, i32* @var_601034_i, align 4
  ret i32 %4
}
