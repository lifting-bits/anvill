...
@llvm.compiler.used = appending global [4 x ptr] [ptr @sub_4003b4__All_Svl_B_0, ptr @main, ptr @__libc_start_main, ptr @var_601034_i], section "llvm.metadata"
...
define i32 @main(i32 %0, ptr %1, ptr %2) #0 {
  %4 = load i32, ptr @var_601034_i, align 4
  ret i32 %4
}
