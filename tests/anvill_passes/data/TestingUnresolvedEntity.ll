...
%struct.State = type { %struct.AArch32State }
%struct.AArch32State = type { %struct.ArchState, %struct.GPR, %struct.SR, i64 }
...
%struct.Reg = type { i32 }
%struct.SR = type { i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, [2 x i8] }
...
define i32 @sub_12b30__A_SBI_B_0.6(i8* %0) #0 {
  %2 = load i32, i32* @__anvill_stack_plus_24, align 4
  %3 = load i32, i32* @__anvill_stack_plus_20, align 4
  %4 = load i32, i32* @__anvill_stack_plus_16, align 4
  %5 = load i32, i32* @__anvill_stack_plus_12, align 4
  %6 = load i32, i32* @__anvill_stack_plus_8, align 4
  %7 = load i32, i32* @__anvill_stack_plus_4, align 4
  %8 = ptrtoint i8* %0 to i32
  ...
  %28 = load i32, i32* bitcast (i32 (i32)* @sub_60__AII_B_0 to i32*), align 4
  %29 = call i32 @sub_10__AIIIII_B_0(i32 %27, i32 %26, i32 0, i32 %28)
  %30 = call i32 bitcast (i32 (i8*, i32, i8*)* @sub_38__A_SBI_SBI_B_0 to i32 (i32, i32, i32, i32)*)(i32 %29, i32 %26, i32 0, i32 1071644672)
  %31 = icmp eq i32 %30, 0
...
inst_12b94_not_taken_12b98.i:                     ; preds = %inst_12b84_not_taken_12b88.i
  %40 = shl nsw i32 %36, 2
  %41 = add i32 %40, add (i32 ptrtoint (i32* @__anvill_pc to i32), i32 76696)
...
inst_12c44.i:                                     ; preds = %inst_12b94_not_taken_12b98.i, %inst_12b84_not_taken_12b88.i
  ...
  %46 = inttoptr i32 %10 to i32*
  store i32 %2, i32* %46, align 4
  %47 = inttoptr i32 %13 to i32*
...
sub_12b30__A_SBI_B_0.lifted.exit:                 ; preds = %inst_12c44.i, %1
  ...
  %49 = call %struct.Memory* @__remill_function_return(%struct.State* undef, i32 %7, %struct.Memory* undef)
  ret i32 %48
}
...
; Function Attrs: noinline
declare i32 @sub_fffffff0__AIIIII_B_0(i32 %0, i32 %1, i32 %2, i32 %3) #0

; Function Attrs: noinline
declare i32 @sub_60__AII_B_0(i32 %0) #0

; Function Attrs: noinline
declare i32 @sub_10__AIIIII_B_0(i32 %0, i32 %1, i32 %2, i32 %3) #0

; Function Attrs: noinline
declare i32 @sub_38__A_SBI_SBI_B_0(i8* %0, i32 %1, i8* %2) #0

; Function Attrs: readnone
declare i32 @__anvill_complete_switch(i32 %0, ...) local_unnamed_addr #1

; Function Attrs: noduplicate noinline nounwind optnone
declare %struct.Memory* @__remill_function_return(%struct.State* nonnull align 1 %0, i32 %1, %struct.Memory* %2) local_unnamed_addr #2
