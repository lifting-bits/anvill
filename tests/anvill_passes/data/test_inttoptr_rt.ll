; ModuleID = 'test_inttoptr_rt.ll'
source_filename = "lifted_code"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu-elf"

@var_601028_l = global i64 3741319167
...
@llvm.compiler.used = appending global [4 x ptr] [ptr @sub_4003b4__All_Svl_B_0, ptr @main, ptr @__libc_start_main, ptr @var_601028_l], section "llvm.metadata"
...
define i32 @main(i32 %0, ptr %1, ptr %2) #0 {
  %4 = load i64, ptr @var_601028_l, align 8
  %5 = icmp eq i64 %4, 0
  %.sroa.14.12.insert.ext = select i1 %5, i32 0, i32 42
  ret i32 %.sroa.14.12.insert.ext
}
