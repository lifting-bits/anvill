...
@llvm.compiler.used = appending global [4 x ptr] [ptr @sub_4003b4__All_Svl_B_0, ptr @main, ptr @__libc_start_main, ptr @var_601030_l], section "llvm.metadata"
...
define i32 @main(i32 %0, ptr %1, ptr %2) #0 {
  %4 = load i64, ptr @var_601030_l, align 8
  %5 = icmp ne i64 %4, 0
