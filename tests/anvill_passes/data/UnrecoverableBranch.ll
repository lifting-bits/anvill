; ModuleID = 'UnrecoverableBranch.ll'
...
define ptr @slice(ptr %0, i64 %RAX, i64 %RDX, ptr nocapture %RIP_output) local_unnamed_addr #2 {
  %2 = add i64 %RDX, %RAX
  %3 = icmp eq i64 %2, 0
  %4 = tail call zeroext i1 (i1, ...) @__remill_flag_computation_zero(i1 zeroext %3, i64 %RAX, i64 %RDX, i64 %2) #3
  %5 = icmp slt i64 %2, 0
  %6 = tail call zeroext i1 (i1, ...) @__remill_flag_computation_sign(i1 zeroext %5, i64 %RAX, i64 %RDX, i64 %2) #3
  %7 = lshr i64 %RAX, 63
  %8 = lshr i64 %RDX, 63
  %9 = lshr i64 %2, 63
  %10 = xor i64 %9, %7
