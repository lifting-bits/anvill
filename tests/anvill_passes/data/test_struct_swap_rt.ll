...
@llvm.compiler.used = appending global [7 x i8*] [i8* bitcast (i64 (i64, i64, i32 ()*)* @sub_4003b4__All_Svl_B_0 to i8*), i8* bitcast (i32 (i32, i8**, i8**)* @main to i8*), i8* bitcast (i32 (i32 (i32, i8**, i8**)*, i32, i8**, i32 (i32, i8**, i8**)*, i32 ()*, i32 ()*, i8*)* @__libc_start_main to i8*), i8* bitcast (i64* @var_601028_l to i8*), i8* bitcast (i64* @var_60102c_l to i8*), i8* bitcast (i32* @data_601028_i to i8*), i8* bitcast (i32* @data_60102c_i to i8*)], section "llvm.metadata"
...
@data_601028_i = alias i32, bitcast (i64* @var_601028_l to i32*)
@data_60102c_i = alias i32, bitcast (i64* @var_60102c_l to i32*)
...
define i32 @main(i32 %0, i8** %1, i8** %2) #0 {
  %4 = load i32, i32* bitcast (i64* @var_601028_l to i32*), align 8
  %5 = load i32, i32* bitcast (i64* @var_60102c_l to i32*), align 8
  store i32 %5, i32* bitcast (i64* @var_601028_l to i32*), align 8
  store i32 %4, i32* bitcast (i64* @var_60102c_l to i32*), align 8
  ret i32 %5
}
