...
@llvm.compiler.used = appending global [4 x ptr] [ptr @sub_4003b4__All_Svl_B_0, ptr @main, ptr @__libc_start_main, ptr @var_601028_i], section "llvm.metadata"
...
define i32 @main(i32 %0, ptr %1, ptr %2) #0 {
  %4 = load i32, ptr @var_601028_i, align 4
  %5 = lshr i32 %4, 7
  store i32 %5, ptr @var_601028_i, align 4
  %6 = and i32 %5, 1
  ret i32 %6
}
