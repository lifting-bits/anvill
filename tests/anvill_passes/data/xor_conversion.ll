...
define dso_local void @xor_as_not(ptr nocapture readonly %0, ptr nocapture %1) local_unnamed_addr #0 {
  ...
  store i8 %8, ptr %9, align 1, !tbaa !2
  %10 = select i1 %6, ptr getelementptr inbounds ([12 x i8], ptr @.str.1, i64 0, i64 0), ptr getelementptr inbounds ([13 x i8], ptr @.str, i64 0, i64 0)
  %11 = call i32 @puts(ptr nonnull dereferenceable(1) %10)
  store i8 %8, ptr %9, align 1, !tbaa !2
  br i1 %6, label %18, label %12

12:                                               ; preds = %2
  %13 = call i32 @puts(ptr nonnull dereferenceable(1) getelementptr inbounds ([47 x i8], ptr @.str.2, i64 0, i64 0))
  %14 = getelementptr inbounds i8, ptr %0, i64 12
  %15 = load i8, ptr %14, align 1, !tbaa !2
  %16 = load i8, ptr %3, align 1, !tbaa !2
  %17 = sub i8 %15, %16
  store i8 %17, ptr %1, align 1, !tbaa !2
  br label %21

18:                                               ; preds = %2
  %19 = call i32 @puts(ptr nonnull dereferenceable(1) getelementptr inbounds ([46 x i8], ptr @.str.3, i64 0, i64 0))
  %20 = getelementptr inbounds i8, ptr %1, i64 1
  store i8 0, ptr %20, align 1, !tbaa !2
  br label %21
...
declare dso_local i32 @puts(ptr nocapture readonly) local_unnamed_addr #1
